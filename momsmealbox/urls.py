...
admin.site.index_title = 'Momsmeal Box Admin Panel'                 # default: "Site administration"
admin.site.site_title = 'Momsmeal Box Technologies Admin Panel' # default: "Django site admin"
urlpatterns = [
